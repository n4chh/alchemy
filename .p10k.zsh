# 
# VARIABLES PROYECTO ALCHEMY
#
# Con estas variables podemos cambiar color e iconos de nuestra barra de 
# manera sencilla sin tener que estar buscando donde estaban dichos iconos
# La lista es la siguiente:
#   - OI: Icono del sistema operativo
#   - OIB: Color del fondo del icono
#   - OIF: Color del icono
#   - PI: Icono del prompt o linea de entrada
#   - PIF: Color de la tipografia
#   - PIB: Color del fondo 
#   - OF: Color de las lineas 
#   - DF: Color de los directorios
OF=130
OI='󱎶'
OIB=103
OIF=46
...
PIF=255
PIB=130
# Generated by Powerlevel10k configuration wizard on 2023-04-11 at 17:02 UTC.
...
#
#   for i in {0..255}; do p/rint -Pn "%K{$i}  %k%F{$i}${(l:3::0:)i}%f " ${${(M)$((i%6)):#3}:+$'\n'}; done
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%${OF}F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%${OF}F├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%${OF}F╰─'
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=$OF
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=$OF
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$OIF
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=$OIB
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=$OI

  ################################[ prompt_char: prompt symbol ]################################
  # Green prompt symbol if the last command succeeded.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$PIF
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=1
  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION=$PI
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$DF
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$DF
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$DF
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n%F{4} ㉿%F{2}%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n@%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%f%n%F{4} ㉿%F{2}%m'
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%F{7}-> '
